...
- **Relative size adjectives** ("a **large** orange", "a **small** banana",
  "**jumbo** shrimp") also trigger a clarification asking for the actual
  weight, rather than a guessed reference weight — "large"/"small"/"jumbo"
  etc. vary too much across foods and people to estimate reliably. This
